...
<link rel="stylesheet" href="style.css">
    ...
    <title>  صفحة الطلاب ذات الوضع المادي وسط</title>
...
<style>
    ...
    <h3>صفحة الطلاب ذات الوضع المادي وسط </h3>
...
$D1="وسط";
$i=1;
$sql="select id,name,section,level from abdo.table3 where financial='$D1'  ";
...
<a href="index.php" class="book-a-table-btn">العودة للصفحة الرئيسية</a>
</center>
</body>
</html>